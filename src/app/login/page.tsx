              ...
              {!showOtpInput && (
                <div className="mb-6 stagger-3">
                  <button 
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-surface border border-border hover:bg-surface-secondary text-text-primary font-semibold py-3.5 rounded-xl transition-all outline-none focus:ring-4 focus:ring-primary/20 shadow-sm"
                  >
